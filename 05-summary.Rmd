# 5 成功安裝 bookdown, 且順利 deploy 到 github.io
...
5.3 新增沒有內容的檔案, 名字為 .nojekyll 的檔案到 _book 目錄下,  詳細內容參考 [github 404 not found due to missing .nojekyll](https://stackoverflow.com/questions/11577147/how-to-fix-http-404-on-github-pages) 就可以成功看到 https://marconijiang.github.io/_book/index.html 的內容