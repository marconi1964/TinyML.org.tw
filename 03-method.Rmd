# 3 將 RMarkdown blogdown 內容 deploy 到 Netlify
參考 [Ref. 1 Using github  章節](https://alison.rbind.io/post/new-year-new-blogdown/#using-github)

3.1 設定 .gitignore : 雖然不知道這時候設定 .gitignore 的必要性, 還是照著說明做
```
file.edit(".gitignore")
```
...
3.2 blogdown  檢查 check_gitignore()  
...
3.4 在 Netlify 網站上建置並且 Publish site    
